...
export default function Login() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#FAF8F7] px-4">
      ...
      <div className="hidden lg:flex w-full max-w-5xl h-[550px] rounded-xl overflow-hidden shadow-lg bg-[#FFC515]">
        ...
        <div className="w-1/2 bg-[#FEEBDD] flex flex-col items-center justify-center rounded-tl-[100px]">
